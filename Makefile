...
build/x86/bios/x86/32/hd.bin: build/x86/bios/x86/32 build/x86/bios/x86/32/fat32.bin build/x86/bios/x86/16/mbr.bin
    ...
    sfdisk build/x86/bios/x86/32/hd.bin < src/x86/32/boot/sfdisk.conf
...
build/x86/bios/x86/16/mbr.bin: build/x86/bios/x86/16 src/x86/16/boot/asm/mbr.asm
    $(NASM) $(NASMFLAGS16) src/x86/16/boot/asm/mbr.asm -o build/x86/bios/x86/16/mbr.bin
...
build/x86/bios/x86/16/vbr.bin: build/x86/bios/x86/16 src/x86/16/boot/asm/vbr.asm
    $(NASM) $(NASMFLAGS16) src/x86/16/boot/asm/vbr.asm -o build/x86/bios/x86/16/vbr.bin

build/x86/bios/root/kern16a.bin: build/x86/bios/root src/x86/16/kernel/asm/kernel16.asm
    $(NASM) $(NASMFLAGS16) src/x86/16/kernel/asm/kernel16.asm -o build/x86/bios/root/kern16a.bin
...
x86/64_all: build/x86/uefi/hd.bin build/x86/bios/x86/64/hd.bin build/x86/bios/root/kern64c.elf

x86/32_all: build/x86/bios/x86/32/hd.bin build/x86/bios/root/kern32c.elf

x86/16_all: build/x86/bios/x86/16/hd.bin

all: x86/64_all x86/32_all x86/16_all
